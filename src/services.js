export const SERVICES = [
  ...
  { id: "n8n", name: "n8n", subdomain: "n8n", port: 7003, desc: "Build complex workflows and automate tasks across hundreds of apps with a visual, node-based editor." },
  ...
  { id: "immich", name: "Immich", subdomain: "immich", port: 8007, desc: "Store, organize, and search photos and videos with AI-powered face recognition, object detection, and timeline view." },
  ...
  { id: "romm", name: "RomM", subdomain: "romm", port: 8016, desc: "Manage, scrape, and play retro game ROMs with metadata, box art, and web-based emulation support." },
