export const SERVICES = [
  ...
  { id: "trilium", name: "Trilium", subdomain: "trilium", port: 8015, desc: "Create and collaborate on documents, whiteboards, and knowledge bases in a local-first workspace." },
